...
def extract_image(request):
    # Verifique se um arquivo de imagem válido foi carregado
    if 'file' not in request.files:
        raise BadRequest("Parâmetro de arquivo ausente")

    file = request.files['file']
    if file.filename == '':
        raise BadRequest("O arquivo fornecido é inválido")
...
if __name__ == "__main__":
    print("Começando gerando codificações para imagens encontradas...")
    # Calcular rostos conhecidos
